...
function lenientLitImportPlugin() {
    return {
        ...
        async transform(code, id) {
            ...
            decoratorImports.forEach((decoratorImport) => {
                ...
                while ((decoratorMatch = code.match(decoratorImport))) {
                    console.warn(`Warning: the file ${id} imports from '${decoratorMatch[3]}' when it should import from '${decoratorMatch[3]}.js'`);
            ...
            directiveImports.forEach((directiveImport) => {
                ...
                while ((directiveMatch = code.match(directiveImport))) {
                    console.warn(`Warning: the file ${id} imports from '${directiveMatch[3]}${directiveMatch[4]}' when it should import from '${directiveMatch[3]}${directiveMatch[4]}.js'`);
...
const allowedFrontendFolders = [
    frontendFolder,
    path.resolve(generatedFlowImportsFolder),
    path.resolve(__dirname, 'node_modules')
];
function setHmrPortToServerPort() {
    return {
...
export const overrideVaadinConfig = (customConfig) => {
    return defineConfig((env) => mergeConfig(vaadinConfig(env), customConfig(env)));
};
//# sourceMappingURL=vite.generated.js.map